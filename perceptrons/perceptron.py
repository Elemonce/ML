...
class Perceptron:
        ...
        for i in range(self.n_iter):
            ...
            for xi, target in zip(X, y):
                ...
                if np.all(init == self.w_) == False:
                    print("update, xi, b:", update, xi, self.b_)
                # If update is 0, converts False to 0 and adds no error. If update is 1 
                # (because it can only be 1 here, this being a classification algoritm with 1s and 0s), then 
                # adds an error.
    ...
    def predict(self, X):
        ...
        # If the target was 0, and the prediction was 1
